...
int main(int argc, char *argv[]) {
	...
	/* arr_n_ptr_%d_%d = (size_t *) calloc(allocation_size, sizeof(size_t)); */
	...
	init_array(arr_n_ptr_%d_%d, array_size, stride);
	...
	if (verify_array(arr_n_ptr_%d_%d, allocation_size) < 0) {
		if (stride == 0)
...
#endif /* DEBUG */
	', th_idx, i, th_idx, i, th_idx, i, th_idx, i, th_idx, i, th_idx, i, th_idx, i, th_idx, i, th_idx, i, th_idx, i, th_idx, i, th_idx, i)')')
